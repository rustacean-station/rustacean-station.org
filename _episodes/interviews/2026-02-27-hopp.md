...
Allen Wyma talks with [Costa Alexoglou](https://blog.alexoglou.com/) and [Iason Paraskevopoulos](https://iparaskev.com/), creators of [Hopp](https://www.gethopp.app/), a tool that is made for developers to have a seamless remote pairing session. Hopp is built with Tauri and Rust and is open source.
