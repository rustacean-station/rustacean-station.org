...
And we should probably talk about (_unintelligible— 10:41_) some crates like the
...
and we will happily help you make an episode with Oli where we talk about const-
ification. That sounds great.
...
takes a `Foo`. It takes an instance of the trait. And then you call copy with a
