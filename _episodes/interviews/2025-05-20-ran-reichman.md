...
- [@1:03] - Welcome to the [Ran Reichman](https://www.linkedin.com/in/ran-reichman-740163b7/), Co-Founder & CEO of [Flarion](https://www.flarion.io/).
- [@1:25] - Ran Reichman introducing himself.
- [@2:08] - Can you tell us a bit about yourself?
...
- [@3:19] - When did you start using Rust?
  - Background in C++
- [@3:58] - Why did you think that Rust is good for this start-up company? Is Rust good for start-up companies?
...
- [@6:22] - Have you considered other languages?
  - C++
- [@7:02] - Can you describe the type of people who you find interested in Rust who you felt are a better fit to your company?
...
- [@10:45] - How do you make sure the crates you depend on are secure and fast?
...
- [@13:23] - Could you, please, elaborate a bit more on the nature of Rust in your use case? What do you mainly do with Rust? Do you use async Rust?
...
- [@15:18] - Are the new employees in the company already experienced in Rust or do they learn it on the job?
...
- [@17:44] - Can you elaborate a bit more what are you avoiding in Rust?
  - Channels, async. If it is possible we prefer to use single core.
- [@18:41] - How easy for you to recruit developers? Our company is mostly C++ and Python.  When I introduced Rust code into the Python group, for performance, I saw a lot of resistance from the developers.
...
- [@20:56] - What was the learning process and learning resources of the people who learned Rust in the company that you might recommend?
...
- [@23:18] - I do a lot of training. Practice and feedback provides the real value.
...
- [@24:28] - The more experienced people also learn a lot from the interaction with the junior developers.
  - The same with management.
- [@25:04] - Do you have any suggestions for someone who'd like to find work in Rust/C/etc. and is comfortable with them, but only has web dev experience (career wise)? The transition seems borderline impossible.
...
- [@27:01] - What should I do to increase my chances to get employed by you?
  - apply...
...
- [@29:49] - Time-travel: What would you say to someone who has 1-2 years to prepare, what to learn to increase their chances in getting hired?
  - To be more ambitious.
  - 99% of all projects churn.
  - Pick something that interests you an be persistent with it.
- [@31:52] - Some specific types of projects to work on?
  - Game engines
...
- [@33:28] - I also recommend people to invest in open source, but most people abandon it quickly. Those who do continue will stand out.
  - Most people don't go deep so if you do you are ahead of most people.
- [@34:15] - For those, a good start is trying to help in an existing open source project. What do you think about that? Contribute to an existing project or create your own?
...
- [@35:46] - A lot of this work is not difficult, but time-consuming.
  - [Proof of work](https://en.wikipedia.org/wiki/Proof_of_work)
- [@36:11] - How do you evaluate your decision to use Rust?
  - we don't regret it
  - benefit of starting from scratch
  - to early to say
- [@37:19] - What are the parts of Rust and crates that are exceptionally good for you and what are the areas where the Rust world could improve? Things that hurt you?
...
- [@39:53] - Follow up to finding work as a web dev: any suggestions for types of repos to that would be appreciated by employers? In your opinion of course. I'm contributing to programming languages, for example. (compilers)
...
- [@49:45] - If you are talking to other founders, CTOs, technology manager, what would you recommend them how to decide to use or not to use Rust?
...
- [@51:43] - What other subject would you like to talk about?
  - [Flarion on Linkedin](https://www.linkedin.com/company/flarion/) for available jobs.
- [@53:25] - What are the main technological challenges ahead of Flarion for the new people who join the team?
  - Distributed database for data processing.
  - Issues of scale
  - Memory management
  - New and interesting technologies at customers.
- [@54:58] - Who are your customers? What kind of companies could be your customers?
